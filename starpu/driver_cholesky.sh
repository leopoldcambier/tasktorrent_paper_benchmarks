...
# PRUNE=0 TEST=0 SCHED=lws NPROWS=8 NPCOLS=8 NUM_BLOCKS=32   BLOCK_SIZE=2048 sbatch -c 32 -n 64 run_cholesky.sh
...
RANDOM_SIZES=32   PRUNE=0 TEST=0 SCHED=lws NPROWS=8 NPCOLS=8 NUM_BLOCKS=2048 BLOCK_SIZE=32   sbatch -c 32 -n 64 run_cholesky.sh
